...
用户已明确：关务与加拿大私人地址询价先完成，私人地址同时提供自有运价与 Freightcom。所有后台配置、查询和历史入口同步提供 CLI。当前实现与运行限制见 [操作说明](../../apps/console/native-business.md) 和 [窄管理合同](../rfcs/2026-09-07-native-customs-residential-admin-v1.md)。后续 OCR、导出、邮件订舱和 SO 识别排在这两条业务流程之后。
