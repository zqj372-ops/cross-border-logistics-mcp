...
not a generated execution ID。Vector 2 是 change 分支，因此没有 `target_release_id`。No
implementation may add fields to either payload without a schema/RFC version。
