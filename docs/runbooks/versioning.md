...
当前对外版本：`0.005`，对应内部 npm semver `0.0.5`。本次发布修正 FCL 本票费用元数据保存，并统一简化模板代入、费用编辑和报价汇总流程。
...
| 用途 | 当前值 | 下一版 | 权威位置 |
| --- | --- | --- | --- |
| 对外产品版本 | `0.005` | `0.006` | `src/logistics_mcp/version.ts` |
| npm 包版本 | `0.0.5` | `0.0.6` | `package.json`、`deploy/cli/package.json` |
