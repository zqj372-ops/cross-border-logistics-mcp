...
当前对外版本：`0.006`，对应内部 npm semver `0.0.6`。本次发布修正 FCL 费用模板编辑、共享费用确认、版本选择和报价前发布检查。
...
| 用途 | 当前值 | 下一版 | 权威位置 |
| --- | --- | --- | --- |
| 对外产品版本 | `0.006` | `0.007` | `src/logistics_mcp/version.ts` |
| npm 包版本 | `0.0.6` | `0.0.7` | `package.json`、`deploy/cli/package.json` |
