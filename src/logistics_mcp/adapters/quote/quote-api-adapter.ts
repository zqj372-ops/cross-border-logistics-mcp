...
import {
  QUOTE_V2_CONTRACT_VERSION,
  QUOTE_V2_RESULT_VERSION,
  quoteV2InputSchema,
  quoteV2ResultSchema,
} from "./quote-v2-contract";

export { quoteV2InputSchema, quoteV2ResultSchema } from "./quote-v2-contract";

const QUOTE_PATH = "/quotes/zone-preview";
const AVAILABLE_VERSION = QUOTE_V2_RESULT_VERSION;
const UNAVAILABLE_VERSION = "quote-preview-unavailable@2026-08-13" as const;
const CONTRACT_VERSION = QUOTE_V2_CONTRACT_VERSION;
