...
export const residentialRatesSchema=z.object({
 ...
 extensions:z.object({zone_controls_v1:z.array(z.object({zone:z.number().int().min(0).max(999),enabled:z.boolean(),fuel_percent:amount.nullable()}).strict()).max(1000)}).strict().optional(),
