...
**当前对外版本：`0.004`。** 后续每次受控发布按 `0.005`、`0.006` 递增；npm 使用对应的合法 semver `0.0.4`、`0.0.5`。规则和发布检查见 [版本号规则](docs/runbooks/versioning.md)。
...
```sh
npm install --global https://www.freightclaw.net/downloads/freightclaw-cli-0.004.tgz
freightclaw --version
freightclaw status
```
...
- [版本号规则与递增清单](docs/runbooks/versioning.md)
