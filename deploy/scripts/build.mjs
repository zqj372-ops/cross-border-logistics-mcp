...
mkdirSync(resolve("dist/services/access-gateway/portal"),{recursive:true});
cpSync("services/access-gateway/portal/fcl_smtp_send.py","dist/services/access-gateway/portal/fcl_smtp_send.py");
...
await build({entryPoints:["deploy/scripts/migrate-fcl-sqlite-offline.ts"],outfile:"dist/deploy/scripts/migrate-fcl-sqlite-offline.mjs",bundle:true,format:"esm",platform:"node",target:"node22",banner:nodeEsmBanner,sourcemap:false,legalComments:"none"});
