...
test -s "$ROOT_DIR/docs/rfcs/2026-09-02-mcp-server-architecture-v1.md"
test -s "$ROOT_DIR/docs/rfcs/2026-09-02-read-preview-staging-profile-v1.md"
test -s "$ROOT_DIR/deploy/compose.read-preview-staging.override.yml.example"
test -s "$ROOT_DIR/docs/runbooks/read-preview-staging.md"
