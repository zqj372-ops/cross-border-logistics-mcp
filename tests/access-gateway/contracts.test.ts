...
describe("Unified Access Gateway Draft 2020-12 contracts", () => {
  it("ships closed schemas for exchange, errors, and JWKS", () => {
    ...
    expect(files).toEqual([
      ...
      "application-mcp-exchange-request.schema.json",
      "application-mcp-exchange-response.schema.json",
      ...
      "customs-history-get-request.schema.json",
      "customs-history-get-response.schema.json",
      "customs-history-list-request.schema.json",
      "customs-history-list-response.schema.json",
      ...
      "portal-fcl-case-confirmation.schema.json",
      "portal-fcl-case-customer-supplement.schema.json",
      "portal-fcl-case-error.schema.json",
      "portal-fcl-case-input.schema.json",
      "portal-fcl-case-internal-view.schema.json",
      "portal-fcl-case-list-query.schema.json",
      "portal-fcl-case-list.schema.json",
      "portal-fcl-case-public-summary.schema.json",
      "portal-fcl-case-staff-supplement.schema.json",
      "portal-fcl-case-status-update.schema.json",
      "portal-fcl-case-submission.schema.json",
      "portal-fcl-case-success.schema.json",
      "portal-fcl-inquiry-input.schema.json",
