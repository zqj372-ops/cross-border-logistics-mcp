...
> 范围说明（2026-09-06）：本文件保留 MCP Admin/fixture 控制流程的说明。当前企业门户、统一 Key、询价、关务和人员 PDF 操作由 [apps/console](../console/README.md) 提供；它们已有独立实现及发布记录。本文中的 quote/PDF 未注册等状态指旧 MCP 工具范围，当前整体进度见 [状态台账](../../docs/product/2026-09-05-mcp-product-redesign/18-current-status-and-gaps.md)。
