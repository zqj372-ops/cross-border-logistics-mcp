...
export function createCliGuide(ui) {
  ...
  function page() {
    ...
    <section class="panel workspace-cli-guide"><div class="panel-body"><h2>后台也能通过 CLI 管理</h2><p>本地开发版已支持渠道配置、发布回退与询价处理。网页登录后确认 CLI 连接，两端使用同一份记录和账号权限。当前 v0.002 下载包包含这组命令。</p><p>在当前开发分支构建后，用 <code>node dist/cli/bin/freightclaw.mjs workspace</code> 查看登录步骤；执行 <code>workspace commands</code> 查看完整管理命令。</p><div class="channel-actions">${link('渠道与仓库', 'channels')}<a class="button" href="/console/workspace-cli.md" target="_blank" rel="noopener">管理命令说明 ${icon('arrow')}</a></div></div></section><div class="cli-body"><article><section class="cli-step"><div class="cli-step-title"><span>1</span><h2>安装并检查连接</h2></div><p>复制下方命令安装，或下载上方安装包后使用 npm 安装本地文件。当前通过本站提供安装包，未发布到公共 npm registry。</p>${block(installCommand, 'install')}${block('freightclaw --version\nfreightclaw status', 'status')}<p class="muted">连接检查只说明门户状态；每次业务调用仍会检查服务授权与来源数据。</p><a class="text-button" href="/downloads/freightclaw-cli-0.002.sha256" download>下载安装包校验值</a></section>
