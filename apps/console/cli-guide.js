...
export const cliDownload = '/downloads/freightclaw-cli-0.002.tgz';
...
export function createCliGuide(ui) {
  ...
  function example() {
    return `<div class="cli-example-links"><a class="button" href="/downloads/cli-0.002/examples/${selected.id}.json" download="${selected.id}.json">下载 ${selected.id}.json</a><span>合成输入示例，使用前请替换</span></div>${block(command(), 'business')}${block(`freightclaw schema ${selected.command}`, 'schema', '复制 Schema 命令')}`;
  }
