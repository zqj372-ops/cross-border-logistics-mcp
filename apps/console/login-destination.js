...
const allowedPages = new Set(['cases', 'operations', 'account', 'customs', 'tax', 'quote', 'quote-history', 'customs-history', 'workbench', 'api-keys', 'calls', 'members']);
const allowed = page => allowedPages.has(page) || /^case\/[0-9a-f-]{36}$/u.test(page);
